          ...
          <div class="modal-body">
            <div class="filter-sidebar">
              ...
              <div class="filter-group">
                ...
                <div class="filter-options">
                  <label class="filter-option"><input
                      type="checkbox"><span>SERVER</span></label>
                  <label class="filter-option"><input
                      type="checkbox"><span>DESKTOP</span></label>
              ...
              <div class="filter-group">
                ...
                <div class="filter-options">
                  <label class="filter-option"><input
                      type="checkbox"><span>AM5</span></label>
                  <label class="filter-option"><input
                      type="checkbox"><span>SP3</span></label>
                  <label class="filter-option"><input type="checkbox"><span>LGA
                      1700</span></label>
                  <label class="filter-option"><input
                  ...
                  <label class="filter-option"><input type="checkbox"><span>LGA
                      2011</span></label>
                  <label class="filter-option"><input
                      type="checkbox"><span>TGX40</span></label>
                </div>
              </div>
              ...
              <div class="filter-group">
                ...
                <div class="filter-options">
                  <label class="filter-option"><input
                      type="checkbox"><span>128</span></label>
                  <label class="filter-option"><input
                      type="checkbox"><span>56</span></label>
                  <label class="filter-option"><input
                      type="checkbox"><span>48</span></label>
                  <label class="filter-option"><input
                      type="checkbox"><span>40</span></label>
                  <label class="filter-option"><input
                      type="checkbox"><span>32</span></label>
                  <label class="filter-option"><input
              ...
              <div class="filter-group">
                <h5>Dòng CPU</h5>
                <div class="filter-options">
                  <label class="filter-option"><input type="checkbox"><span>Intel
                      Core Ultra </span></label>
                  <label class="filter-option"><input type="checkbox"><span>Intel
                      Core Ultra</span></label>
                  <label class="filter-option"><input type="checkbox"><span> AMD
                      EPYC</span></label>
                  <label class="filter-option"><input type="checkbox"><span>AMD
                      Ryzen 5</span></label>
                  <label class="filter-option"><input type="checkbox"><span>ntel
                      Core i9</span></label>
                  <label class="filter-option"><input type="checkbox"><span>Intel
                      Xeon</span></label>
                </div>
