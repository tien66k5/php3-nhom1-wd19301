  ...
  <div class="container">
    ...
    <div class="container-fluid">
      ...
      <div class="col-sm-6 text-black">
        ...
        <form action="/registerForm" method="POST" style="width: 23rem;">
          @csrf
          ...
          <input type="text" name="name" id="registerName" class="form-control form-control-lg" />
          ...
          <input type="text" name="firstname" id="registerFirstname" class="form-control form-control-lg" />
          ...
          <input type="text" name="lastname" id="registerLastname" class="form-control form-control-lg" />
          ...
          <input type="email" name="email" id="registerEmail" class="form-control form-control-lg" />
          ...
          <input type="text" name="phone" id="registerPhone" class="form-control form-control-lg" />
          ...
          <div class="form-outline mb-4">
            ...
            <span class="text-danger" id="passwordError">@error('password_confirmation') {{ $message }} @enderror</span>
        </div>
